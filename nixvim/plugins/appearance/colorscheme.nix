_: {
  ...
  # noctalia renders into foot's palette. That is the point of the choice --
  # the whole host runs one scheme, and noctalia is its source of truth
  # (modules/home/wm/mango/noctalia.nix drives foot, gtk, qt, mango, btop,
  ...
  # the same scheme by hand instead.
  #
